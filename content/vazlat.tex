...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item unsupervised learning (mygreatlearning GAN)
		\item uses of generative models, motiváció, synthetic data
		\item Density estimation (mygreatlearning Boltz)
		\item generative modellek fajtái (Explicit, implicit) (mygreatlearning Boltz)
	\end{itemize}
	...
	\begin{itemize}
		\item  mygreatlearning explanation
		\item auto encoder úgy általában
		\item variational auto encoder mitől "variational"
		\item példa alkalmazásra: deep fake
	\end{itemize}
\end{itemize}

Arcfelismerés 
	- transition, miért lesz erről most szó
\begin{itemize}
