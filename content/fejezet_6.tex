...
% 	\item lsh
% 	\item HE 
% 	\item kriptográfiai hash függvények
...
% A korábbi módszerek arra céloztak, hogy az arclenyomatok módosításával maszkoljuk a személyes adatokat.
% Visszautal a támadómodellre
% Feltételeztem, hogy az arclenyomatok titkosítás nélnül vannak tárolva.
% Vannak biometrikus sablonvédelmi módszerek, amelyek egyéb biometrikus adatok (pl újlenyomat) tárolására fejlesztettek ki.

% Lényege, hogy egy biometrkius sablont áttranszformálják, majd transzformált állapotban tárolják
% Hitelesítés során egy illető biometrikus adatát ugyanazzal a módszerrel transzformálják, majd azt összehasonlítják a tárolt sablonokkal. Ha van egyezést akkor sikerült hitelesíteni.
